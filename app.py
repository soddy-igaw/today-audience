...
if st.session_state.view == "detail_realestate":
    ...
    <div class="detail-hero">
      <div class="detail-emoji">🔥</div>
      <span class="detail-tag">테마주</span>
      <div class="detail-title">뉴스 보고 30분 안에 종목 검색한 사람</div>
      <div class="detail-sub">광통신 600% 폭등 뉴스에 증권앱 검색이 터진 사람, 테마주 추격 매수 직전입니다</div>
      <div class="detail-meta">2026.04.15 · 오늘의 오디언스 #12</div>
    </div>

    <div class="quote-box">
      <p>"출근길에 뉴스 봤어요. 광통신 관련주 600% 올랐다고.<br>바로 토스증권 열어서 '빛과전자' 검색했어요.<br>이미 상한가였는데, 관련주 리스트 보면서<br>아직 안 오른 종목 찾고 있었어요. 회의 중에도."<br><br>— K씨, 29세, 스타트업 마케터</p>
    </div>

    <div class="section">
      <p>2026년 4월, 광통신 테마주가 폭발했습니다. 엔비디아 젠슨 황이 GTC 2026에서 광통신을 차세대 AI 인프라 핵심으로 언급하자, 한 달 새 600% 이상 오른 종목이 등장했습니다.</p>
      <p>증권사 마케터들은 "주식 관심자"를 타겟합니다. 하지만 매일 증권앱을 여는 사람과, <strong>뉴스 하나 보고 30분 안에 종목 검색을 시작하는 사람</strong>은 완전히 다릅니다.</p>
      <p>K씨처럼 <strong>뉴스앱에서 테마 기사를 읽고 → 증권앱에서 관련 종목을 검색하는 시간 간격이 30분 이내</strong>인 사람. 이 사람이 테마주 추격 매수자입니다.</p>
    </div>

    <div class="quote-box">
      <p>"솔직히 광통신이 뭔지 잘 몰라요.<br>근데 600% 올랐다는데 관련주가 더 있잖아요.<br>아직 안 오른 거 찾아서 소액이라도 넣으려고요.<br>증권 커뮤니티에서 '2차 수혜주' 리스트 보고 있어요."<br><br>— K씨</p>
    </div>

    <div class="section">
      <div class="section-label">BEHAVIOR TIMELINE</div>
      <p style="font-size:0.78rem;color:#999;margin-bottom:20px">K씨의 앱 사용 변화를 DMP로 추적하면</p>
      <div class="tl">
        <div class="tl-item">
          <div class="tl-dot tl-green" style="background:#000;box-shadow:0 0 0 2px #000"></div>
          <div class="tl-day" style="color:#000">MINUTE 0 · 뉴스 트리거</div>
          <div class="tl-title">📰 뉴스앱 증권/IT 카테고리 기사 클릭</div>
          <div class="tl-desc">테마주 폭등 기사 체류 시간 2분+ → 단순 스크롤이 아닌 정독</div>
        </div>
        <div class="tl-item">
          <div class="tl-dot tl-green" style="background:#000;box-shadow:0 0 0 2px #000"></div>
          <div class="tl-day" style="color:#000">MINUTE 5~30 · 종목 검색 시작</div>
          <div class="tl-title">📈 증권앱에서 관련 종목명 검색</div>
          <div class="tl-desc">뉴스 클릭 후 30분 내 증권앱 종목 검색 = 핵심 시그널. 기사에 언급된 종목명 + "관련주" "수혜주" 검색</div>
          <div class="tl-bar-wrap">
            <div style="font-size:0.7rem;color:#888;margin-bottom:4px">뉴스→증권앱 전환 속도</div>
            <div class="tl-bar-bg"><div class="tl-bar-fill" style="width:85%"></div></div>
            <div style="font-size:0.68rem;color:#000;font-weight:700;margin-top:2px">85% — 30분 이내 전환</div>
          </div>
        </div>
        <div class="tl-item">
          <div class="tl-dot tl-yellow" style="background:#888;box-shadow:0 0 0 2px #888"></div>
          <div class="tl-day" style="color:#000">HOUR 1~6 · 커뮤니티 탐색</div>
          <div class="tl-title">💬 증권 커뮤니티앱 접속 급증</div>
          <div class="tl-desc">네이버증권 토론방, 알파스퀘어 등에서 "2차 수혜주" "아직 안 오른 종목" 탐색</div>
        </div>
        <div class="tl-item" style="margin-bottom:0">
          <div class="tl-dot tl-red" style="background:#000;box-shadow:0 0 0 2px #000"></div>
          <div class="tl-alert">
            <div style="font-size:0.68rem;color:#000;font-weight:700;margin-bottom:4px">⚡ HOUR 6~24 · 여기서 잡아야 합니다</div>
            <div class="tl-title">매수 주문 / 관련 ETF 조회 / 추가 종목 검색</div>
            <div class="tl-desc">뉴스 트리거 후 24시간 내 매수 전환. 이 타이밍에 증권사 광고 전환율 4배+</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="section">
      <div class="cmp-grid">
        <div class="cmp-card cmp-left"><h4>일반 주식 유저</h4><p>증권앱 매일 접속<br>보유 종목 확인 위주<br>뉴스 소비 일정<br>검색 빈도 변화 없음<br>테마 반응 느림</p></div>
        <div class="cmp-card cmp-right"><h4>테마주 추격 매수자</h4><p>뉴스 후 30분 내 종목 검색<br>커뮤니티 접속 3배 급증<br>"관련주" "수혜주" 검색<br>새벽~아침 시간대 활성<br>24시간 내 매수 전환</p></div>
      </div>
    </div>

    <div class="section">
      <div class="section-label">DMP에서 잡는 법</div>
      <p><strong>[테마주 추격 매수자]</strong><br>뉴스앱 증권/IT 기사 체류 2분+ (당일)<br>+ 30분 내 증권앱 종목 검색 전환<br>+ 증권 커뮤니티앱 접속 빈도 2배+ 증가<br>+ 같은 테마 관련 종목 3개+ 검색<br><br><em style="color:#888;font-size:0.8rem">* DMP 실측: 뉴스앱+증권앱 동시 활성 유저 약 52만명 (30일 기준)<br>이 중 뉴스→증권앱 30분 내 전환 유저 약 8만명 추정</em></p>
    </div>

    <div class="section">
      <div class="ind-grid">
        <div class="ind-card"><div class="ind-title">📈 증권사</div><div class="ind-desc">"광통신 관련주 리포트, 지금 확인하세요"</div></div>
        <div class="ind-card"><div class="ind-title">📊 투자 정보</div><div class="ind-desc">"테마주 실적 검증 리포트 무료 제공"</div></div>
        <div class="ind-card"><div class="ind-title">💰 ETF</div><div class="ind-desc">"개별 종목 리스크 없이, AI 인프라 ETF"</div></div>
        <div class="ind-card"><div class="ind-title">📱 투자 커뮤니티</div><div class="ind-desc">"실시간 테마주 분석, 전문가 의견"</div></div>
      </div>
    </div>

    <div class="insight-box">
      <div class="ins-label">💡 KEY INSIGHT</div>
      <p>"주식 관심자"는 오디언스가 아닙니다.<br><br>뉴스 하나 보고 <strong>30분 안에 종목 검색을 시작하는 사람</strong>이 오디언스입니다.<br><br>이 사람은 이미 지갑을 열 준비가 됐습니다.<br>문제는 정보가 부족한 상태에서 추격 매수한다는 것.<br>"테마주 조심하세요"가 아니라<br>"이 테마의 실적 있는 종목은 이겁니다"를 보내세요.</p>
    </div>

    <div class="ad-compare">
      <p style="font-size:0.85rem;font-weight:700;color:#000;margin-bottom:16px">이 오디언스에게 보내는 광고</p>
      <p style="font-size:0.85rem;color:#999;margin-bottom:8px">❌ "주식 수수료 무료! 지금 계좌 개설하세요"</p>
      <p style="font-size:0.85rem;color:#000;font-weight:600">✅ "광통신 테마, 실적 있는 종목 vs 없는 종목 — 무료 리포트"</p>
    </div>

    <div class="audience-card">
      <p style="font-size:0.68rem;color:#888;font-weight:700;letter-spacing:1.5px;margin-bottom:20px">📋 AUDIENCE CARD</p>
      <h3 style="color:#fff;font-size:1.15rem;font-weight:800;margin-bottom:20px">테마주 추격 매수자</h3>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
        <div><p style="color:#666;font-size:0.7rem;margin-bottom:4px">추정 모수 (DMP 실측)</p><p style="color:#fff;font-size:1.5rem;font-weight:900">~52만</p><p style="color:#555;font-size:0.7rem">뉴스+증권앱 동시 활성</p></div>
        <div><p style="color:#666;font-size:0.7rem;margin-bottom:4px">추천 업종</p><p style="color:#fff;font-size:0.88rem;font-weight:600;line-height:1.6">증권사 · 투자정보<br>ETF · 커뮤니티</p></div>
      </div>
    </div>

    <div class="footer">오늘의 오디언스 #12 · by IGAWorks</div>
    </div>
    """, unsafe_allow_html=True)
