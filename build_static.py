...
.body p,.section p,.quote-box p{font-size:1.1rem;color:#333;line-height:2.1;margin-bottom:24px;letter-spacing:-0.2px}
.body strong,.section strong,.quote-box strong{color:#000;font-weight:800}
.section{padding:32px 0;border-bottom:none}
.section-label{font-size:1.3rem;font-weight:800;color:#000;line-height:1.6;margin:40px 0 16px;letter-spacing:-0.3px}
.quote-box{padding:40px 0;border-top:1px solid #f0f0f0;border-bottom:1px solid #f0f0f0;margin:32px 0;background:none;border-left:none}
.quote-box p{font-style:italic}
.quote-box strong{font-style:normal}
.behavior-cards{display:flex;flex-direction:column;gap:0}
.behavior-card,.behavior-card.highlight{background:none;padding:0 0 24px;position:static;overflow:visible}
.bc-step{display:none}
.bc-title{font-size:1.1rem;font-weight:800;color:#000;line-height:1.4;margin-bottom:4px}
.behavior-card.highlight .bc-title{color:#000}
.bc-desc{font-size:1.1rem;color:#333;line-height:2.1}
.behavior-card.highlight .bc-desc{color:#333}
.bc-num{display:none}
.insight-box{background:#000;padding:48px 32px;margin:48px -24px}
