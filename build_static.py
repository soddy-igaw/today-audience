...
ESSAYS = [
    ...
    {"id":"wegovy","tag":"헬스","title":"한 달에 5kg 빠지니까, 헬스장을 끊었습니다","sub":"GLP-1 다이어트약 처방이 폭발하면서, 운동으로 빼는 사람과 약으로 빼는 사람이 갈리고 있습니다","stat":"~18만","stat_label":"병원예약+약국앱 동시 활성 (DMP)","date":"2026.04.16","img":"https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=800https://images.unsplash.com/photo-1505576399279-0d754c0ce141?w=800&h=400&fit=crop&q=80h=400https://images.unsplash.com/photo-1505576399279-0d754c0ce141?w=800&h=400&fit=crop&q=80fit=crophttps://images.unsplash.com/photo-1505576399279-0d754c0ce141?w=800&h=400&fit=crop&q=80q=80"},
    {"id":"car","tag":"자동차","title":"보조금 빠지면 전기차 가성비가 안 나옵니다","sub":"보조금 축소 뉴스 보고 전기차를 포기한 게 아니라, 선택지를 바꾼 겁니다","stat":"~80만","stat_label":"자동차앱 사용자 (DMP)","date":"2026.04.14","img":"https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=800&h=400&fit=crop&q=80"},
    {"id":"game","tag":"게임","title":"게임 하나 때문에 200만원 씁니다","sub":"신작 출시 전 게임 커뮤니티 접속이 3배 뛰면, 하드웨어 지갑이 열립니다","stat":"~140만","stat_label":"게임앱 사용자 (DMP)","date":"2026.04.14","img":"https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?w=800&h=400&fit=crop&q=80"},
    {"id":"stock","tag":"증권","title":"미장 팔고 나온 돈, 어디로 갔을까","sub":"트럼프 관세에 미장을 판 서학개미, 금으로 갈아탔습니다","stat":"~97만","stat_label":"증권앱 사용자 (DMP)","date":"2026.04.14","img":"https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&h=400&fit=crop&q=80"},
    ...
    {"id":"travel","tag":"여행","title":"비행기값이면 제주에서 3박 합니다","sub":"환율 1,450원 시대, 여행을 포기한 게 아니라 방향을 바꾼 겁니다","stat":"~65만","stat_label":"여행앱 사용자 (DMP)","date":"2026.04.14","img":"https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=800&h=400&fit=crop&q=80"},
    {"id":"pet","tag":"반려동물","title":"첫 사료를 고르는 2주가, 3년을 결정합니다","sub":"2주 안에 펫앱 3개를 동시에 까는 사람은 3년 고객이 됩니다","stat":"~13만","stat_label":"펫앱+커머스 (DMP)","date":"2026.04.13","img":"https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=800&h=400&fit=crop&q=80"},
    {"id":"themestock","tag":"테마주","title":"600% 뉴스 보고 30분 안에 증권앱 연 사람","sub":"광통신 600% 폭등 뉴스에 증권앱 검색이 터진 사람","stat":"~52만","stat_label":"뉴스+증권앱 동시 활성 (DMP)","date":"2026.04.15","img":"https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&h=400&fit=crop&q=80"},
    {"id":"carinsurance","tag":"금융","title":"작년보다 15만원 올랐다면, 이미 갈아탈 준비가 된 사람","sub":"작년보다 15만원 올랐다면, 지금 갈아타세요","stat":"~41만","stat_label":"보험사+비교앱 동시 활성 (DMP)","date":"2026.04.16","img":"https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&h=400&fit=crop&q=80"},
    {"id":"finance","tag":"금융","title":"4월 17일까지, 이 사람은 잠을 못 잡니다","sub":"새벽 2시에 대출앱 3개를 번갈아 여는 사람","stat":"~10만","stat_label":"대출탐색 유저 (DMP)","date":"2026.04.10","img":"https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop&q=80"},
    {"id":"running","tag":"러닝","title":"토요일 아침 7시, 한강에 나타나는 사람","sub":"커머스에서 15만원짜리 러닝화를 반복 조회하면서, 주말 아침 한강에 나타나는 사람","stat":"~48만","stat_label":"러닝앱+커머스 동시 활성 (DMP)","date":"2026.04.15","img":"https://images.unsplash.com/photo-1552674605-db6ffd4facb5?w=800&h=400&fit=crop&q=80"},
    ...
    {"id":"health","tag":"건강","title":"배달앱 지우고 식단앱 깐 사람, 이번엔 진짜입니다","sub":"다이어트를 결심한 게 아니라, 몸이 바뀌기 시작한 겁니다","stat":"~103만","stat_label":"운동앱 사용자 (DMP)","date":"2026.04.14","img":"https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=400&fit=crop&q=80"},
]
