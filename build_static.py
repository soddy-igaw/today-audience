...
ESSAYS = [
    ...
    {"id":"coupang_exit","tag":"쇼핑","title":"쿠팡을 떠나 네이버로 옮긴 사람","sub":"236만 이탈자 중 해외직구로 간 진짜 타겟은?","stat":"~23만","stat_label":"쿠팡 이탈→경쟁앱 전환 9.7%","date":"2026.04.24"},
    ...
    {"id":"realestate_0422","tag":"부동산","title":"5월 9일 전에 팔아야 하는 다주택자","sub":"양도세 중과 유예 만료 D-17, 데드라인에 쫓기는 다주택자","stat":"~43만","stat_label":"부동산앱 매도 전환 + 세무앱 동시 활성","date":"2026.04.22"},
    {"id":"game_0422","tag":"게임","title":"GTA6 출시일 확정 후 게이밍 PC를 사전예약하는 사람","sub":"게임 하나 때문에 200만원 쓰는 사람","stat":"~23만","stat_label":"게임앱+쇼핑앱 동시 활성","date":"2026.04.22"},
    ...
    {"id":"tosspay","tag":"금융","title":"기존 간편결제 사용이 줄고 새 결제앱을 깐 사람","sub":"간편결제 갈아타기가 시작됐습니다. 전통시장까지 퍼지면서 결제 습관이 바뀌는 사람.","stat":"~98만","stat_label":"간편결제앱 전환 행동 유저","date":"2026.04.20"},
