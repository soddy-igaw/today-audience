...
<div style="padding:48px 0 40px">
  ...
  <div style="display:flex;gap:24px;flex-wrap:wrap">
    <div><div style="font-size:1.4rem;font-weight:900;color:#000">22</div><div style="font-size:.65rem;color:#999">오디언스</div></div>
    <div><div style="font-size:1.4rem;font-weight:900;color:#000">8</div><div style="font-size:.65rem;color:#999">카테고리</div></div>
    <div><div style="font-size:1.4rem;font-weight:900;color:#e8530e">매일</div><div style="font-size:.65rem;color:#999">업데이트</div></div>
  </div>
</div>
"""
# Today hero (검정 배경)
