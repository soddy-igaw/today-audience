...
ESSAYS = [
    ...
    {"id":"travel_0423","tag":"여행","title":"유류할증료 보고 해외여행 취소한 사람","sub":"해외에서 국내로 방향을 바꾼 사람","stat":"~185만","stat_label":"해외앱 감소 + 국내 숙박앱 증가","date":"2026.04.23","img":"https://images.unsplash.com/photo-1436491865332-7a61a109db05?w=800&h=400&fit=crop&q=80"},
    ...
    {"id":"wegovy","tag":"헬스","title":"다이어트약 처방 후 운동을 끊은 사람","sub":"GLP-1 다이어트약 처방이 폭발하면서, 운동으로 빼는 사람과 약으로 빼는 사람이 갈리고 있습니다","stat":"~110만","stat_label":"병원예약+약국앱 동시 활성 (DMP)","date":"2026.04.16","img":"https://images.unsplash.com/photo-1505576399279-0d754c0ce141?w=800&h=400&fit=crop&q=80"},
    ...
    {"id":"travel","tag":"여행","title":"해외여행 대신 국내여행으로 전환한 사람","sub":"환율 1,450원 시대, 여행을 포기한 게 아니라 방향을 바꾼 겁니다","stat":"~185만","stat_label":"여행앱 사용자 (DMP)","date":"2026.04.14","img":"https://images.unsplash.com/photo-1436491865332-7a61a109db05?w=800&h=400&fit=crop&q=80"},
    ...
    {"id":"carinsurance","tag":"금융","title":"자동차보험 만기 전 갈아타기 비교 중인 사람","sub":"작년보다 15만원 올랐다면, 지금 갈아타세요","stat":"~9만","stat_label":"보험사+비교앱 동시 활성 (DMP)","date":"2026.04.16","img":"https://images.unsplash.com/photo-1449965408869-ebd3fee7e2c3?w=800&h=400&fit=crop&q=80"},
