...
ESSAYS = [
    ...
    {"id":"stock_0427","tag":"증권","title":"미국주식 팔고 국내 증권앱으로 돌아온 사람","sub":"서학개미가 미장을 떠나고 있어요. 이들이 다음에 여는 앱은?","stat":"~92만","stat_label":"증권앱+은행앱 교차 · DMP 실측","date":"2026.04.27"},
    ...
    {"id":"golf","tag":"골프","title":"접대 때문에 골프 시작한 입문자","sub":"접대 골프 입문자는 고민하지 않아요. 빠르게 사요.","stat":"~8만","stat_label":"골프앱+비즈니스앱 교차 · DMP 실측","date":"2026.04.11"},
]

CHAPTERS = [
    {"label":"금융","ids":["tax_0509","tosspay","safehaven_0420","stock_0427"]},
    {"label":"보험","ids":["insurance_0509"]},
...
body{background:#fff;font-family:'SUIT',sans-serif;-webkit-font-smoothing:antialiased;color:#1a1a1a}
...
<div style="margin-top:48px;padding-top:32px;border-top:1px solid #eee">
  ...
  <div style="display:flex;gap:14px;overflow-x:auto;padding-bottom:8px;-webkit-overflow-scrolling:touch">"""
    ...
    # Contact CTA — 에세이 자체에 CTA가 있으므로 제거
    contact_html = ""
